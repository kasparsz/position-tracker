...
const READ_FILE_NAME = 'dist/position-tracker.min.mjs';
const WRITE_BROTLI_FILE_NAME = 'dist/position-tracker.mjs.br';
const WRITE_GZIP_FILE_NAME = 'dist/position-tracker.mjs.gz';
...
const brotliPromise = new Promise((resolve) => {
...
Promise.all([brotliPromise, gzipPromise]).then(() => {
    fs.unlink(READ_FILE_NAME, () => {});
});